        ...
        {pageNumbers.map(number => (
          <li key={number}>
            <button
              ...
              className={`px-3 py-2 leading-tight border ${currentPage === number ? 'text-blue-600 bg-blue-50 border-blue-300' : 'text-gray-500 bg-white border-gray-300 hover:bg-gray-100 hover:text-gray-700'}`}
            >
              {number}
            </button>
          </li>
